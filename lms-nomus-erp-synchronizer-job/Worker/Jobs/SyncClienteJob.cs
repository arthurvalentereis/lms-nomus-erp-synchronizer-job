...
public class SyncClienteJob
{
    ...
    public async Task ExecuteAsync(long userGroupId, string hashToken, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            await _synchronizationService.SynchronizeClienteAsync(userGroupId, hashToken, cancellationToken);
